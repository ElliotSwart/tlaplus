...
public class DistributedFPSet  {
	...
	public static void main(final String[] args) {
		...
		try {
			...
			if (fpSet instanceof final MultiFPSet multiFPSet) {
                ...
                for (final FPSet set : fpSets) {
                    System.err.println("...with nested instance type: " + set.getClass().getName());
                }
			}
	...
	private static TLCServerRMI lookupTLCServer(final String serverName) throws MalformedURLException, RemoteException, InterruptedException {
