...
public abstract class AbstractDiskGraph {
     ...
     *
     * @param ptr The length of the ptr file up to which this method reads.
     ...
     *
     * @param state The state's fingerprint
     * @param tidx  The corresponding tableau index
     */
     ...
     *
     * @param oos  Length of state checks
